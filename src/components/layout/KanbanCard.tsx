...
export default function KanbanCard({
  ...
  return (
    <>
      <div
        ref={cardRef}
        className={`border-border dark:bg-card rounded-lg border bg-white p-3 shadow-sm transition-all duration-200 ${
          ...
          <div className="flex items-start gap-2">
            {isReadOnly ? (
              ...
              <button
                ...
                className="hover:bg-muted/50 dark:hover:bg-muted/30 mt-0.5 rounded-full p-1"
